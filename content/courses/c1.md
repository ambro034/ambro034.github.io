...
| $R$             | Number of recruiters                                | Number of employees allocated to recruiting new workers                                                                                                          | $r V$                                                              |
...
| $\alpha$        | Elasticity of output with respect to labor          | Percent increase in ouput when the number of producers increases by 1 percent                                                                                    | $\frac{\partial \ln(y)}{\partial \ln(N)}$                          |
...
| $\lambda$       | Public-employment multiplier                        | Additional number of employed workers for each additional worker in the public sector                                                                            | $\frac{d L}{d G}$                                                  |
| $\epsilon^m$    | Microelasticity of unemployment with respect to UI  | Percent increase in unemployment when the generosity of UI increases by 1 percent, keeping tightness constant (so allowing only search effort to repond)         | $\left.\frac{\partial\ln(u)}{\partial\ln(UI)}\right\vert_{\theta}$ |
| $\epsilon^M$    | Macroelasticity of unemployment with respect to UI  | Percent increase in unemployment when the generosity of UI increases by 1 percent, allowing tightness to respond to the UI change (in addition to search effort) | $\frac{d\ln(u)}{d\ln(UI)}$                                         |
