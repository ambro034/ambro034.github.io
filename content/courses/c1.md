...
| $a$             | Technology                       |                                                                                                                                                                  |                                           |
| $\alpha$        | Marginal returns to labor        |                                                                                                                                                                  | $\frac{\partial \ln(y)}{\partial \ln(N)}$ |
...
| $\gamma$        | Wage flexibility                 | Elasticity of the real wage with respect to technology                                                                                                           | $\frac{\partial \ln(w)}{\partial \ln(a)}$ |
| $\beta$         | Worker bargaining power          | Share of the employment surplus captured by workers                                                                                                              | -                                         |
| $\mathcal{F}$   | Firm surplus                     |                                                                                                                                                                  |                                           |
| $\mathcal{W}$   | Worker surplus                   |                                                                                                                                                                  |                                           |
| $\mathcal{S}$   | Total surplus                    |                                                                                                                                                                  | $\mathcal{F} + \mathcal{W}$               |
| $z$             | Value of unemployment            |                                                                                                                                                                  |                                           |
| $E$             | Search effort                    |                                                                                                                                                                  |                                           |
| $U^R$           | Rationing unemployment           |                                                                                                                                                                  | $\lim_{E\to\infty} U$                     |
...
| $\lambda$       | Public-employment multiplier     |                                                                                                                                                                  | $-\frac{d L}{d G}$                        |
| $\epsilon^m$    | Microelasticity of unemployment  | Percent increase in unemployment when the generosity of UI increases by 1 percent, keeping tightness constant (so allowing only search effort to repond)         |                                           |
| $\epsilon^M$    | Macroelasticity of unemployment  | Percent increase in unemployment when the generosity of UI increases by 1 percent, allowing tightness to respond to the UI change (in addition to search effort) |                                           |
